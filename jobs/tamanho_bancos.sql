...
/****** Object:  Job [vs_tamanho_bancos]    Script Date: 06/07/2023 12:26:46 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 06/07/2023 12:26:46 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'vs_tamanho_bancos', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'vs_tamanho_bancos', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@active_start_date=20221213, 
		@active_end_date=99991231, 
		@active_start_time=1, 
		@active_end_time=235959, 
		@schedule_uid=N'a9d9b799-1f84-4541-8881-98874a3caf7a'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
